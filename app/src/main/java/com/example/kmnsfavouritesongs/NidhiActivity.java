...
public class NidhiActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nidhi);

        setUpUI();

        mediaPlayer = new MediaPlayer();
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.mannmera);
    ...
    public void changesong(){
        mediaPlayer.stop();
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.fursat);
        mediaPlayer.start();
        updateThread();
        artistname.setImageResource(R.drawable.fursat);
        songname.setText("FURSAT");
        moviename.setText("Single");
    }
    ...
    public void changesong1(){
        ...
        mediaPlayer.start();
        updateThread();
        artistname.setImageResource(R.drawable.mannmera);
        songname.setText("MANN MERA");
        moviename.setText("Table No. 21");
    }
